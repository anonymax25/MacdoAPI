...
class ProductsController {
    ...
    static async getProducts() {
        const products = await Product.find().populate('ingredients').populate('accessories');
        return products;
    }

    static async getProductById(id) {
        const product = await Product.findOne({_id: id}).populate('ingredients').populate('accessories');
        return product;
    }
